...
void ParticleGenerator::DrawUsingRenderer(SpriteRenderer& Renderer) {
...
void ParticleGenerator::respawnParticle(Particle &particle, GameObject &object, glm::vec2 offset) {
	...
	//this is passed as offset to particle vertex shader but its not really offset, for particle its it's absolute position, 
